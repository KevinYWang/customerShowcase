...
const initialState = { customerList: [], isLoading: false, searchString: null, pageNumber:1, pageSize:50, pageTotal:0};
...
export const actionCreators = {
  requestCustomerData: (searchString,pageNumber) => async (dispatch, getState) => {
    ...
    dispatch({ type: requestCustomerDataType, searchString: searchString, customerList: stateValue.customerList,
    ...
    dispatch({ type: receiveCustomerDataType, searchString: searchString, customerList: customerList,
